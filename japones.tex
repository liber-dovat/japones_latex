...
\renewcommand{\Titulo}{Japon\'es}
\renewcommand{\Subtitulo}{Resumen}
...
\def\vene{$\mathrm{\bv}_\mathrm{n}$} % verbo ene
\def\tenten{。。。}

% modifico los margenes para la parte de los kanjis
...
%         \end{tabular}
      ...
      \subsubsection{Solicitar, dar instrucciones o consejos:}
        ...
        \begin{itemize}
          \item すみませんが、かんじの　よみ\ruby{方}{かた}を　おしえてください。\\
      ...
      \subsubsection{Conjugaci\'on, progreso de la acci\'on:}
        ...
        \begin{itemize}
          ...
          \item
            \begin{itemize}
              \item[-] \ruby{今}{いま}　\ruby{雨}{あめ}が　ふって　いますか。\\
      ...
      \subsubsection{Ofrecerse para realizar una acci\'on:}
        \fbox{\bv ましょうか}
      ...
      \subsubsection{Realizar dos acciones simultaneamente:}
        ...
        \begin{itemize}
          \item \ruby{音楽}{おんがく}を\ruby{聞}{き}きながら\ruby{食事}{しょくじ}します。\\
                Como escuchando m\'usica.
          \item コーヒー　を　のみながら　べんきょうします。\\
        ...
        Tambi\'en se utiliza para acciones que contin\'uan permanentemente
          ...
          \begin{itemize}
            \item はたらきながら　\ruby{日本語}{にほんご}　を　べんきょうします。\\
    ...
    \section{Lección 15}
      ...
      \subsubsection{No se puede:}
        ...
        \begin{itemize}
          ...
          \item ここに\ruby{車}{くるま}を\ruby{止}{と}めてはいけません。\\
      ...
      \subsubsection{Acci\'on cont\'inua en el tiempo:}
        ...
        \begin{itemize}
          \item \ruby{木村}{きむら}\ruby{先生}{えんせい}は　けっこんしています。\\
                La profesora Kimura est\'a casada.
          \item \ruby{私}{わたし}は　\ruby{田中}{たなか}さん　を　しっています。\\
                Conozco al Sr. Tanaka.
          \item パブロさん　は　カネローネス　に　\ruby{住}{す}んでいます。\\
                Pablo vive en Canelones.
          \item 私は　カメラ　を　\ruby{持}{も}っています。\\
                Tengo una c\'amara.
      ...
      \subsubsection{Acci\'ones rutinarias o de larga duraci\'on:}
        ...
        \begin{itemize}
          \item まえに　テニス　を　していましたが、\ruby{今}{いま}　は　していません。\\
...
%========================================
    ...
    \section{Lección 16}
      ...
      \subsubsection{Secuencial, dos o mas verbos ocurren en secuencia:}
        ...
        \begin{itemize}
          \item カルロすさん　は　あさ、ジョギング　を　して、シャワー　を　あびて、\ruby{大学}{だいがく}へ\ruby{行}{い}きます。\\
      ...
      \subsubsection{Conectar oraciones que usan い-adjetivos:}
        ...
        \begin{itemize}
          ...
          \item きのう　は天気が　よくて、\ruby{少}{すこ}し　あつかったです。\\
                Ayer hizo buen clima y estuvo un poco caluroso.
        \end{itemize}
      ...
      \subsubsection{Conectar oraciones que usan な-adjetivos o sustantivos:}
        ...
        \begin{itemize}
          ...
          \item サンパウロ　は　にぎやかで、おもしろい　です。\\
                San Pablo es movida e interesante.
        \end{itemize}

      \subsubsection{Causa o motivo:}
        \fbox{\vi(て)、\tenten \vn(ます)}

        \begin{itemize}
          \item \ruby{風}{かぜ}をひいて、じゅぎょうを\ruby{休}{やす}みました。\\
...
　　　　    \item \ruby{私}{わたし}は　いつも　たって　アイロン　を　かけます。\\
...
%         \end{tabular}
      ...
      \subsubsection{Pasatiempo:}
        ...
        \begin{itemize}
          \item \ruby{私}{わたし} の　しゅみ　は　\ruby{音楽}{おんがく}です。\\
                Mi pasatiempo es la m\'usica.
          \item 私 の　しゅみ　は　\ruby{音楽}{おんがく}　を　きく　ことです。\\
      ...
      \subsubsection{Gustos:}
        ...
        \begin{itemize}
          \item 私は　サッカーが　すきです。\\
                Me gusta el f\'utbol.
          \item 私は　サッカーを　\ruby{見}{み}ることが　すきです。\\
      ...
      \subsubsection{Un acontecimiento ocurre antes que otro:}
        \fbox{\bs{の} / \vi(じしょ) / cuantificador de tiempo まえに、\vn}
        ...
        \begin{itemize}
          \item ウルグアイに\ruby{来}{く}る\ruby{前}{まえ}にスペイン\ruby{語}{ご}をべんきょうしました。\\
                Antes de venir a uruguay estudi\'e español.
          \item ねる\ruby{前}{まえ}に本を\ruby{読}{よ}みます。\\
        ...
        \begin{itemize}
          \item \ruby{食事}{しょくじ}の\ruby{前}{まえ}に\ruby{手}{て}をあらいます。\\
        ...
        \begin{itemize}
          \item 田中さんはー時間まえに\ruby{出}{で}かけました。\\
                El Sr.Tanaka sali\'o hace una hora.
        \end{itemize}

%========================================

    \section{Lección 19 - Forma {た} (た\ruby{形}{けい})}
      ...
      \subsubsection{Tengo la experiencia:}
        \fbox{\bv(た) ことが　あります}

        \begin{itemize}
          \item ピラニアを　つったことが　あります。\\
                Una vez pesqu\'e una piraña.
          \item ぞう　に　のったことが　あります。\\
                Una vez sub\'i a un elefante.
        \end{itemize}

        \subparagraph{Atenci\'on:}
          Este patr\'on no se utiliza para acciones cotidianas.

      \subsubsection{Enumerar verbos:}
        \fbox{\vi(た)り、\vn(た)り　します}

        \begin{itemize}
          \item 日よう日は　かいものしたり、えいがを\ruby{見}{み}たり　します。\\
                Los domingos hago compras, miro pel\'iculas, etc. (Todos los domingos)
          \item 日よう日は　かいものしたり、えいがを見たり　しました。\\
                El domingo hice compras, mir\'e pel\'iculas, etc. (El domingo pasado)
        \end{itemize}

      \subsubsection{Secuencia de acciones:}
        \fbox{\vi(た) / \bs {の} + あとで、\vn}

        \begin{itemize}
          \item あたらしい　カメラ　を　かって　あとで、まえ　の　カメラ　みつかりました。\\
                Despu\'es de comprarme la c\'amara nueva, encontr\'e la vieja.
          \item しゅくだい　を　して　あとで、ばんごはん　を　\ruby{食}{た}べます。\\
                Despu\'es de hacer los deberes, ceno.
          \item しごと　の　あとで、のみに　\ruby{行}{い}きませんか。\\
                >Vamos a beber despu\'es del trabajo?.
        \end{itemize}

      \subsubsection{Cambio de una situaci\'on anterior (involuntaria):}
        \fbox{\adj-い(〜い×){く} / \adj-な(〜な×){に} / \bs{に} なりました}

        \begin{itemize}
          \item
            \begin{itemize}
              \item[\textbf{前:}] くらかったです。\\
                                  Estaba oscuro.
              \item[\textbf{今:}] \ruby{明}{あか}るく　なりました。\\
                                  Est\'a claro (ahora se aclar\'o).
            \end{itemize}
          \item
            \begin{itemize}
              \item[\textbf{前:}] びょうきでした。\\
                                  Estaba enfermo.
              \item[\textbf{今:}] \ruby{元気}{げんき}に　なりました。\\
                                  Estoy saludable (ahora mejor\'e).
            \end{itemize}
          \item
            \begin{itemize}
              \item[\textbf{前:}] \ruby{学生}{がくせい}でした。\\
                                  Era estudiante.
              \item[\textbf{今:}] いしゃに　なりました。\\
                                  Soy m\'edico (ahora me recib\'i de m\'edico).
            \end{itemize}
        \end{itemize}

      \subsubsection{Cambio de una situaci\'on anterior (voluntaria):}
        \fbox{\adj-い(〜い×){く} / \adj-な(〜な×){に} / \bs{に} しました}
        ...
        \begin{itemize}
          \item
            \begin{itemize}
              \item[\textbf{前:}] くらかったです。\\
                                  Estaba oscuro.
              \item[\textbf{今:}] 明るく　しました。\\
                                  Encend\'i la luz (est\'a claro).
            \end{itemize}
          \item
            \begin{itemize}
              \item[\textbf{前:}] へやは　きたなかったです。\\
                                  La habitaci\'on estaba sucia.
              \item[\textbf{今:}] へやを　きれいに　しました。\\
                                  Limpi\'e la habitaci\'on (est\'a limpia).
            \end{itemize}
          \item
            \begin{itemize}
              \item[\textbf{前:}] りんごでした。\\
                                  Hab\'ia una manzana.
              \item[\textbf{今:}] りんご　を　ジャムに　しました。\\
                                  Hice mermelada de manzana.
            \end{itemize}
        \end{itemize}

%========================================

    \section{Lección 20 - Forma Ordinaria (\ruby{普通}{ふつう}\ruby{形}{けい})}
      \subsection{Estilo cortés y estilo informal}
        \begin{tabular}{|l|l|}
          ...
          \ruby{毎日}{まいにち}いそがしいです。　　　　& \ruby{毎日}{まいにち}いそがしい。 \\
          \ruby{音楽}{おんがく}が好きです。　　　　　　& \ruby{音楽}{おんがく}が好きだ。 \\
          \ruby{外国}{がいこく}ではたらきたいです。　　& \ruby{外国}{がいこく}ではたらいきいたい。 \\
          スイスへ\ruby{行}{い}ったことがありません。　& スイスへ\ruby{行}{い}ったことがない。 \\
          \hline
        \end{tabular}

        \begin{itemize}
          \item \textbf{Diario íntimo:}\hfill\\
                \ruby{今日}{きょう}はあさから\ruby{雨}{あめ}が\ruby{降}{ふ}っている。\ruby{私}{わたhし}は\ruby{一日中}{いちにちじゅう}\ruby{家}{いえ}にいて日本語をべんきょうした \ldots\\
                Hoy llovió{} desde la mañana. Me quede todo el día en casa estudiando japonés.

          \item \textbf{Carta:}\hfill\\
                パブロさん、お\ruby{元気}{げんき}ですか。私は今日本にいます。こうようがとてもきれいです。\\
        ...
        \begin{enumerate}
          ...
          \item \hfill\\
            \begin{tabular}{ll}
              ...
              \ldotsうん、げんき／げんきだ／げんきだよ。 & (usada por varones) \\
              \ldotsうん、げんき／げんきよ。 & (usada por mujeres) \\
              \ldotsううん、げんきじゃない。 & (usada por ambos sexos) \\
            \end{tabular}
          \item
            \begin{itemize}
              \item \ruby{手}{て}[を]あらう？\\
                    >Te lavas las manos?
              \item あしたロチャ[へ]\ruby{行}{い}く？\\
          ...
          \item
            \begin{itemize}
              \item[-] はさみ、もって[い]る\\
                       >Tienes tijeras?
              \item[-] \ldotsうん、もって[い]る。\\
                       S\'i, tengo.
              \item[-] \ldotsううん、もって[い]ない。\\
                       No, no tengo.
            \end{itemize}
          \item
            \begin{itemize}
...
\chapter{Resumen}
  ...
  \begin{itemize}
    ...
    \item Verbo como sustantivo:\\
          \bv\ColEmph{じしょ}こと
    \item Pasatiempo:\\
          しゅみは\bv\ColEmph{じしょ}ことです
    \item Gustos:\\
          \bsは\bv\ColEmph{じしょ}ことがすきです
    \item Ser capaz; es posible:\\
          \bs / \bv\ColEmph{じしょ}ことができます
    \item Un acontecimiento ocurre antes que otro:\\
          \bs\ColEmph{の} / \vi\ColEmph{じしょ} / cuantificador de tiempo まえに、\vn
    \item Tengo la experiencia:\\
          \bv\ColEmph{た} ことが　あります
    \item Enumerar verbos:\\
          \vi\ColEmph{た}り、\vn\ColEmph{た}り　します
    \item Secuencia de acciones:\\
          \vi\ColEmph{た} / \bs \ColEmph{の} + あとで、\vn
    \item Cambio de una situaci\'on anterior (involuntaria):\\
          \adj-い(\ColEmph{い×}){く} / \adj-な(\ColEmph{な×}){に} / \bs{に} なりました
    \item Cambio de una situaci\'on anterior (voluntaria):\\
          \adj-い(\ColEmph{い×}){く} / \adj-な(\ColEmph{な×}){に} / \bs{に} しました
  \end{itemize}
